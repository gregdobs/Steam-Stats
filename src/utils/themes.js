...
export const THEME_BASE_BLUR = { dark: 30, light: 26, vapor: 46, ink: 4 };
...
export const THEMES = [
  ...
  { id: 'ink', label: 'Midnight contrast', note: 'Near-solid panels, no blur cost', swatchBg: 'linear-gradient(150deg,#0f141d,#05070b)', swatchAccent: '#8fd6ff' },
];
